...
window.clearNotifications = () => {
    ...
    renderNotifications(); renderFriends(); renderGroups();
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    renderClients(); renderProjects(); renderInventory(); renderFinance(); renderProviders(); renderGallery(); renderNotifications(); renderFriends(); renderGroups(); updateStats();
});
...
function updateTopbarProfile() {
    ...
    if (currentUser !== 'admin') {
        restrictedMods.forEach(mod => {
            const btn = document.querySelector(`.nav-link[data-mod="${mod}"]`);
